...
public final class FetchManager {
 ...
 private String fetch(String url)throws Exception{try{return doFetch(url,new Proxy(Proxy.Type.HTTP,new InetSocketAddress("127.0.0.1",3388)));}catch(Exception e){if(state.isCancelled())throw e;return doFetch(url,Proxy.NO_PROXY);}}
