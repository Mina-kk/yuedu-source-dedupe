...
public final class YckWebClient extends WebViewClient {
 ...
 @Override public void onReceivedHttpError(WebView view,WebResourceRequest request,WebResourceResponse response){if(request.isForMainFrame())listener.onLoadError(request.getUrl().toString());}
